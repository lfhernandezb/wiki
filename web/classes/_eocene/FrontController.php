...
class FrontController {	
	...
	*******************************************************************************/
    ...
    function &instance($configFile = NULL) { 
        static $frontController;
        if (is_null($frontController)) { 
            $frontController = new FrontController($configFile);
        } 
	...
	*****************************************************/
	function executeCommand(){
		...
		$this->language=new MultiLanguage();
		$this->_setMembers();	
	...
	************************************************************/
	...
	function _setRootFolder(){
		...
		if(empty($this->rootFolder)) $this->writeError(110);
	...
	function _setRootURL(){
		...
		if(empty($this->rootURL)) $this->writeError(111);	
		if($this->rootURL=="/"){
